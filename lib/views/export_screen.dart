...
class _ExportScreenState extends State<ExportScreen> {
  ...
  // Fungsi untuk menyimpan sertifikat tunggal
  Future<File?> _saveSingleCertificate(File imageFile) async {
    try {
      return await ImageUtils.saveImageToDownloads(imageFile);
    } catch (e) {
      debugPrint('Error saving single certificate: $e');
      return null;
    }
  }
              ...
              Center(
                child: ElevatedButton.icon(
                  ...
                  onPressed: () async {
                    ...
                    final result = await _saveSingleCertificate(imageFile);
                    Navigator.pop(context);
                    
                    if (result != null) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text('Sertifikat disimpan di: ${result.path}'),
